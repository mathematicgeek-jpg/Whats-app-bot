...
export async function processMessage(parsed, options = { sendMessages: true }) {
  ...
  const currentNode = workflow.nodes[session.currentNodeId || 'WELCOME'];
  if (!currentNode) {
    ...
    return {
      messages: [{ text: welcomeNode.text, buttons: welcomeNode.buttons }],
      session
    };
  }
  ...
  // ================================================
    ...
    const result = await handleInputCaptureNode(phone, text, isButton, session, workflow, currentNode);
    outboundMessages = result.messages;
    session = result.session;
  }
  // ================================================
  ...
  // ================================================
    ...
    const result = handleConditionNode(phone, text, session, workflow, currentNode);
    outboundMessages = result.messages;
    session = result.session;
  }
  // ================================================
  ...
  // ================================================
    ...
    const result = await handleNavigationNode(phone, text, isButton, session, workflow, currentNode);
    outboundMessages = result.messages;
    session = result.session;
  }
